setwd("/Users/zuonianyao/Documents/GR5243/Project4")
library("rhdf5")
library(data.table)
library(dplyr)
...
save.image("/Users/zuonianyao/Documents/GR5243/Project4/fit.rdata")
...
serVis(json, open.browser = FALSE)
...
# mt <- matrix(result)
# nm <- names(lyric[[1]]$songs)[c(2:3,6:21,31)]
test_df <- data.frame(test_res)

test_cls <- predict(xgb_model, data.matrix(test_df))

lyr_sim <- lyr
load("/Users/QinqingLiu/Documents/2016Fall/Zuozuo/Music/lyr.RData")
